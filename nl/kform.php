...
<?php include("header.inc"); ?>
    ...
    <p class="indent">
        ...
        a. Het komt in het bestand voor onder een andere plaatsnaam. Raadpleeg eerst de <strong>Topografische
            verwijslijst</strong> via het linkermenu en ga dan terug naar de Titellijst.<br/>
    ...
    <form action="kres.php" method="post" class="indent">
        <table bgcolor="#FFFFFF" cellpadding="2" cellspacing="5" border="2" bordercolor="#B94A85" class="indent">
            ...
            <tr>
                <td align="center"></td>
                <td><strong>Stadia: [<a href="../images/thesaurusST.pdf" title="thesaurus stadia"
