...
END_OF_HTML;
    ...
    <table bgcolor="#FFFFFF" cellpadding="3" cellspacing="2" border="2" bordercolor="#B94A85" width="70%">
        ...
        while (($row = mysqli_fetch_object($result)) && $r++ <= $DisplayCount) {
			...
			<tr><td valign="top" align="middle" width="40%"><IMG SRC="https://geoplaza.vu.nl/projects/kloosterlijst/foto/$row->foto" title="$row->FO"></td> <td valign="top"><iframe src="https://geoplaza.vu.nl/projects/kloosters_vue/index.html?nomenu=t&language=en&id=$row->ID" style="width:100%;height:350px;border:none;"></iframe></td></tr><br>
