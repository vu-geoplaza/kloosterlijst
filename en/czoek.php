...
<hr>
<p>
<p class="indent">Search for correspondences between <em>Monasticon Batavum</em> and the Census. Give in a place name; the search will yield one or more entries of the <em>Monasticon Batavum</em> according to Volume and Page, which are linked to records in the list of Monasteries.</p>
...
<tr><td>
<input type="submit" name="knop" value="search" class="button"> <input type="reset" value="clear" class="button">
</td></tr>
</table>
</form>
</p>
