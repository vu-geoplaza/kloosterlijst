...
<p class="indent">The main database <strong>(Monasteries)</strong> contains all independent communities of men and women who adopted a religious life of some sort, disregarding their status in canon law and including even house and court beguinages. Monasteries, convents, friaries and religious houses whose existence has been confirmed by the sources, have been assigned a unique identification code. This code is the key to a record in which a standardised set of data – if available – has been entered. Further below the structure of the record and the types of data to be found in the various fields will be explained. A negative decision has been taken on monasteries who are mentioned in scholarly literature but whose existence finds no support in the sources. These are enumerated in the list of <strong>Eliminations</strong>, which for each item offers a brief argumentation why it was rejected Additional datasets included in the site relate to three types of institutions which are akin to the monasteries: one for <strong>Granges and Urban Refuges</strong>, one for <strong>Houses of <em>Terminarii</em></strong> and one for <strong>Collegiate Churches</strong> (for more details see below).</p>
